...
/**
 * Created by kh1441 on 4/14/15.
 */


    public class AttractionsView extends Activity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            final String jsonResults = getIntent().getStringExtra("Attractions");
            ...
            CustomAttractionsAdapter adapter = new CustomAttractionsAdapter(this, itemname, imgid, vicinity);
