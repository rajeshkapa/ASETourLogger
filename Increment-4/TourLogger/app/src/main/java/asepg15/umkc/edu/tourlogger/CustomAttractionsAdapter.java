 ...
 */
    ...
    public class CustomAttractionsAdapter extends ArrayAdapter<String> {
        ...
        public CustomAttractionsAdapter(Activity context, String[] itemname, String[] imgid, String[] vicinity) {
